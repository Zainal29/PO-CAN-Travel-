<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Rute Perjalanan</h1>
            <p class="mt-1 text-sm text-slate-500">Perbarui jadwal keberangkatan, tarif, atau alokasi armada bus untuk rute ini.</p>
        </div>
    </x-slot>
